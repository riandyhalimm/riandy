          ...
          <div class="head-depan tengah">
            <div class="row">
              ...
              <div class="col-md-11">
                ...
                <p><i class="fa fa-map-marker fa-fw"></i> Sistem Informasi yang memuat data lokasi kampus dimedan</p>
              </div>
            </div>
    ...
    <nav class="navbar navbar-default navbar-utama" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="data.php"><i class="fa fa-list-ul"></i> DATA KAMPUS</a></li>
            <li><a href="peta.php"><i class="fa fa-map-marker"></i> PETA PERSEBARAN KAMPUS</a></li>
